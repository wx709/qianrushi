...
-- Date        : Sun Jul  5 01:16:33 2026
-- Host        : DESKTOP-EAP3H84 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top ascent_xdma_stream_0 -prefix
--               ascent_xdma_stream_0_ ascent_xdma_stream_0_stub.vhdl
-- Design      : ascent_xdma_stream_0
...
entity ascent_xdma_stream_0 is
  Port ( 
...
architecture stub of ascent_xdma_stream_0 is
  ...
  attribute X_INTERFACE_INFO of s_axis_c2h_tdata_0 : signal is "xilinx.com:interface:axis:1.0 S_AXIS_C2H_0 TDATA";
  attribute X_INTERFACE_MODE of s_axis_c2h_tdata_0 : signal is "slave";
  attribute X_INTERFACE_PARAMETER of s_axis_c2h_tdata_0 : signal is "XIL_INTERFACENAME S_AXIS_C2H_0, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s_axis_c2h_tlast_0 : signal is "xilinx.com:interface:axis:1.0 S_AXIS_C2H_0 TLAST";
  attribute X_INTERFACE_INFO of s_axis_c2h_tvalid_0 : signal is "xilinx.com:interface:axis:1.0 S_AXIS_C2H_0 TVALID";
  attribute X_INTERFACE_INFO of s_axis_c2h_tready_0 : signal is "xilinx.com:interface:axis:1.0 S_AXIS_C2H_0 TREADY";
  attribute X_INTERFACE_INFO of s_axis_c2h_tkeep_0 : signal is "xilinx.com:interface:axis:1.0 S_AXIS_C2H_0 TKEEP";
  attribute X_INTERFACE_INFO of m_axis_h2c_tdata_0 : signal is "xilinx.com:interface:axis:1.0 M_AXIS_H2C_0 TDATA";
  attribute X_INTERFACE_MODE of m_axis_h2c_tdata_0 : signal is "master";
  attribute X_INTERFACE_PARAMETER of m_axis_h2c_tdata_0 : signal is "XIL_INTERFACENAME M_AXIS_H2C_0, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m_axis_h2c_tlast_0 : signal is "xilinx.com:interface:axis:1.0 M_AXIS_H2C_0 TLAST";
  attribute X_INTERFACE_INFO of m_axis_h2c_tvalid_0 : signal is "xilinx.com:interface:axis:1.0 M_AXIS_H2C_0 TVALID";
  attribute X_INTERFACE_INFO of m_axis_h2c_tready_0 : signal is "xilinx.com:interface:axis:1.0 M_AXIS_H2C_0 TREADY";
  attribute X_INTERFACE_INFO of m_axis_h2c_tkeep_0 : signal is "xilinx.com:interface:axis:1.0 M_AXIS_H2C_0 TKEEP";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of stub : architecture is "ascent_xdma_stream_0_core_top,Vivado 2025.2";
begin
end;
